...
doc2vec_model = Doc2Vec(docs,dm = 0, alpha=0.1, vector_size = 20, min_alpha=0.025)
...
print(text_tokens)
vector = doc2vec_model.wv.similarity('总书记','中国')
print(vector)
...
topic_list=lsi.print_topics(num_topics=20,num_words=20)
